    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/lib")
                ...
                .Include(lte + "js/pages/Utilidades.js")
                .Include(lte + "js/pages/CheckList.js")
                .Include(lte + "js/pages/Cartas.js")
                .Include(lte + "js/pages/Evaluaciones.js")
                .Include(lte + "js/pages/Solicitudes.js")
                .Include(lte + "js/pages/Promocion.js")
                .Include(lte + "js/pages/Scoring.js")
                .Include(lte + "js/pages/Fichas.js")
                .Include(lte + "js/pages/EvaluacionDetallada.js")
                .Include(lte + "js/pages/EvaluacionSimple.js")
                ...
                .Include(lteplugins + "maskMoney/jquery.maskMoney.js")
                .Include(lteplugins + "maskMoney/jquery.toast.js")
                .Include(lteplugins + "timepicker/bootstrap-timepicker.min.js")
                .Include(lteplugins + "iCheck/icheck.min.js")
                .Include(lteplugins + "jquery-loading/jquery.loading.min.js")
            ...
            bundles.Add(new StyleBundle("~/Content/css")
                ...
                .Include("~/Content/adminlte/css/jquery.toast.css")
                .Include("~/Content/adminlte/css/loading.css")
